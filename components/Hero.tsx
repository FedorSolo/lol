      ...
      >
        <div className="relative flex flex-col items-start">
          <motion.p
            ...
            className="inline-block bg-[#533e8e] rounded-md px-3 py-1.5 font-mono text-xs md:text-sm tracking-widest2 text-snow uppercase mb-6"
          >
            {content.eyebrow}
          </motion.p>
          ...
          <motion.p
            ...
            className="inline-block bg-[#533e8e] rounded-md px-4 py-3 mt-8 max-w-xl text-snow text-base md:text-lg font-body"
          >
            {content.subtitle}
          </motion.p>
        </div>
