  ...
  const sidebarContent = (
    <>
      <div className="px-6 py-6 border-b border-white/10 flex items-center justify-between">
        <span className="flex items-center gap-2 font-display text-xl text-snow tracking-wide"><img src="/logo-mark.png" alt="" className="w-5 h-5 object-contain" />CumbrePeak Admin</span>
        <button
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between px-4 h-14 border-b border-white/10 bg-obsidian sticky top-0 z-30">
        <span className="flex items-center gap-2 font-display text-lg text-snow tracking-wide"><img src="/logo-mark.png" alt="" className="w-5 h-5 object-contain" />CumbrePeak Admin</span>
        <button
